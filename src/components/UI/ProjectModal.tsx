          ...
          <div className="mb-8">
            ...
            <div className="flex flex-wrap gap-2">
              {project.tags.map((tag, index) => (
                <span
                  key={index}
                  className="px-3 py-1 bg-orange-100 dark:bg-orange-900/30 text-orange-800 dark:text-orange-300 text-sm rounded-full border border-orange-200 dark:border-orange-700"
                >
                  {tag}
                </span>
              ))}
