...
const QADashboard: React.FC = () => {
  return (
    <section id="qa-dashboard" className="py-12 sm:py-16 lg:py-20 bg-white dark:bg-black overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8 lg:mb-12">
          <BugCounter 
            ...
            className="p-4 sm:p-6 bg-white dark:bg-dark-800 rounded-lg shadow-md border border-gray-200 dark:border-dark-600"
          />
          <BugCounter 
            targetCount={189} 
