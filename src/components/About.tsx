        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <Card className="p-6">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">Especialidades</h3>
              <p className="text-gray-700 dark:text-gray-300">
            ...
            <Card className="p-6">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">Localização</h3>
              <p className="text-gray-700 dark:text-gray-300">
