...
const Skills: React.FC = () => {
  ...
  return (
    <section id="skills" className="py-12 sm:py-16 lg:py-20 bg-gray-50 dark:bg-dark-800">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 lg:mt-16 bg-white dark:bg-dark-700 rounded-lg p-6 sm:p-8 border border-gray-200 dark:border-dark-600">
          <h3 className="text-lg sm:text-xl font-semibold mb-6 text-center text-gray-900 dark:text-white">
